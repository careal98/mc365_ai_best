...
const AiBestCasePage = () => {
    ...
    const fetchData = async (offset: number) => {
        ...
        const response = await fetch(
            `https://mc365-ai-best-djgy.vercel.app/api/data/?year=${year}&month=${month}&doctorId=${doctorId}&offset=${offset}&limit=${limit}`,
            {
            method: "GET",
            mode: "no-cors",
            }
    ...
    const checkData = async () => {
        try {
        const response = await fetch(
            `https://mc365-ai-best-djgy.vercel.app/api/check/count/?year=${year}&month=${month}&doctorId=${doctorId}`,
            {
            method: "GET",
            mode: "no-cors",
            }
