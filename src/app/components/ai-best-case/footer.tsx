...
const Footer = ({
  ...
  return (
    <div className="w-full h-[80px] bg-white px-4 items-center flex justify-between gap-2 shadow-md">
      {
        dataLegth <= 3 &&
      <button
      className="border-[1px] w-full py-3 rounded-lg border-[#ff6600] shadow-md"
      ...
      <button
        className="border-[1px] w-full py-3 rounded-lg border-[#ff6600] bg-[#ff6600] shadow-md"
